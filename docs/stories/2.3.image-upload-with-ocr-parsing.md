...
- **Coding Standards**: ⚠️ Mostly Compliant (one issue)
  ...
  - **Issue**: OCR prompt is inlined in `llmService.ts` (line 36-37) instead of being in `src/services/prompts.ts` per coding standards
